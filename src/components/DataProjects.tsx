    ...
    return (
        <>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-3 gap-12 sm:gap-0 lg:gap-8 pt-4 pb-12'>
                <img src="https://raw.githubusercontent.com/ichsan-frds/Bank-Customer-Deposit-Classification/refs/heads/main/BankCustomerDepositClassificationImage.jpg" alt="Project" 
                    className='col-span-1 md:col-span-2 lg:col-span-1 rounded-md object-cover sm:aspect-square sm:w-[256px] sm:h-[256px]'/>
                <div className='flex-col md:col-span-3 lg:col-span-2 space-y-4'>
                    <div className='flex gap-x-6 sm:text-sm md:text-base text-slate-600'>
                        ...
                        <span className='flex gap-x-2 text-xs self-center'>Machine Learning</span>
                    </div>
